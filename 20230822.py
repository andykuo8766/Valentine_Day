...
def upperHalfHeart(firstDirection: str, parameter: int, rangeParameter: int, direction: str, dParameter: int, forwardParameter: int):
...
if __name__ == "__main__":
    ...
    girlFriend = input("Please enter your girlfriend's name: ")
    ...
    turtle.goto(339, - 50)
    arrow()
    returnInitialPoint(0, 130)
    turtle.color("#CD5C5C", "pink")
    turtle.write(name, font=("gungsuh", 30,), align="center")
    returnInitialPoint(130, 40)
    turtle.write(girlFriend, font=("gungsuh", 30,), align="center")
